...
public class Koopa : MonoBehaviour, IRestartGameElement
{
    public enum TState
    {
        IDLE = 0,
    ...
    public GameObject ShellDefinitva;
    ...
    public GameObject Kill()
    {
        ...
        StartCoroutine(Hide());
        ShellDefinitva = Instantiate(ShellPrefab, this.transform.position + new Vector3(0.5f,1.0f,0), transform.rotation);

        return ShellDefinitva;
